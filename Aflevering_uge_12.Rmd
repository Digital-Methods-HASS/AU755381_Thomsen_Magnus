...
author: "Magnus Vrang Thomsen & Laurits Corydon Dybdahl"
...
Year_vector <- Western_Europe[[3]]
homicides_per_100k_vector <- Western_Europe[[4]]

ggplot(data=Western_Europe)+
  aes(x=Year_vector,y=homicides_per_100k_vector)+
...
The visualisation shows a clear decline in homocides in England, Italy along with the other countries from the dataset. So it shows that these countries are more civilized, however it does not say anything about all the other countries that are not included in the dataset, and therefore it is impossible to give a conclusive answer to the question in general, only that the countries in the dataset have grown more civilized over time.